          ...
          <div className="md:flex gap-4 space-y-4 md:space-y-0 w-full md:w-3/4">
            <div className="w-full">
              ...
              <InputIcon
                ...
                className="w-full border border-blue-800 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-800 placeholder:text-blue-800 bg-white text-blue-800 shadow"
              />
              {errors.name && (
