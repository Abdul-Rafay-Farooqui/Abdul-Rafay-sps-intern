...
const Header = ({ title, subtitle, description }) => {
  return (
    <section className="w-full min-h-[250px] h-[300px] xl:h-[250px] flex bg-blue-900 text-white rubik">
      <div className="h-full w-full bg-cover bg-center text-center bg-blue-900 text-white bg-no-repeat bg-[url('https://res.cloudinary.com/dwiplkg4o/image/upload/v1755079927/bg_t0w6vt.jpg')] flex flex-col lg:flex-row items-stretch relative">
