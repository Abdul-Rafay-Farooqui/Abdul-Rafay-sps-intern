...
const Banner = () => {
  ...
  return (
    <section className="w-full  flex bg-blue-900 text-white">
      <div className="h-full w-full bg-blue-900 text-white bg-cover bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/dwiplkg4o/image/upload/v1755079927/bg_t0w6vt.jpg')] flex flex-col lg:flex-row items-stretch relative">
