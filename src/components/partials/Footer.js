        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
          ...
          <div className="flex gap-12 mt-8 justify-self-center lg:justify-self-end">
            ...
            >
              {/* Twitter SVG */}
              <svg
                className="w-8 h-8 text-gray-300 hover:text-blue-400 transition-colors duration-200"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              {/* Facebook SVG */}
              <svg
                className="w-8 h-8 text-gray-300 hover:text-blue-600 transition-colors duration-200"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
